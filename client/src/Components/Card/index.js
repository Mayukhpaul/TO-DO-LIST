...
const Card = (props) => {
  const deleteTask = async (title) => {
    await axios.delete(`/task/delete/${title}`);
  ...
  return (
    <>
      ...
      <div class="inline-flex flex-col space-y-2 items-center justify-end flex-1 h-full p-4 bg-basic-600 rounded-xl mb-8 border">
